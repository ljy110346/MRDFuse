...
# **1. 读取测试数据**
test_ir_path = "data/jiazhuangxian/test/test_ir.xlsx"
test_raman_path = "data/jiazhuangxian/test/test_raman.xlsx"
test_labels_path = "data/jiazhuangxian/test/test_labels.xlsx"
...
y_true = torch.tensor(df_labels.values, dtype=torch.long).squeeze()
...
# **5. 加载已训练的模型参数**
checkpoint = torch.load("weights/model_jiazhuangxian.pth", map_location=device)

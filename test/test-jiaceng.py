...
# **1. 读取测试数据**
test_ir_path = "data/jiaceng/test/test_ir.xlsx"
test_raman_path = "data/jiaceng/test/test_raman.xlsx"
test_labels_path = "data/jiaceng/test/test_labels.xlsx"
...
# **5. 加载已训练的模型参数**
checkpoint = torch.load("weights/model_jiaceng.pth", map_location=device)
